...
function showRoles(e) {
    ...
    idUsuarioSeleccionado = dataItem.PersonaClienteId;
...
function VerificarIdentificacion() {
    ...
    function (data) {
        ...
        if (data.Data[0] != null) {
            ...
            $('#TipoPersona_id').data('kendoDropDownList').trigger("change");
